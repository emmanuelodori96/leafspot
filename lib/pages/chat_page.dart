...
class Chat extends StatefulWidget {
  Chat({this.image, this.name, this.groupId, this.fcmToken,this.uid, this.spec});

  String? image, name, groupId, fcmToken,uid, spec;
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              dataController!.sendOneOnOneMessageToFirebase(
                                  data: data,
